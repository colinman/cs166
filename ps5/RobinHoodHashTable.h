...
//	int count = 0;
	...
	bool shouldReplace(size_t hash_index, size_t intended_bucket) const;
	size_t calcDiff (size_t index, size_t intended_bucket) const; 
	int containsWithStartIndex(size_t hash_index, int data) const;
